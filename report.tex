...
improvement is driven entirely by hard negative fine-tuning; qualitative
error analysis identifies yes/no questions and multi-hop reasoning as the
...
HotpotQA contains approximately 20\% yes/no questions~\cite{yang2018hotpotqa}.
Flan-T5-xl occasionally generates explanatory text rather than a binary answer:
\begin{quote}
\small
