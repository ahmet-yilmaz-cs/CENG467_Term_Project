...
DPR + Hard Negatives    & —     & —     & —     & In progress (Hard Negatives is generated, Fine-Tuning is pending) \\
\bottomrule
\end{tabular}
...
\midrule
GitHub repository       & Open (\url{https://github.com/ahmet-yilmaz-cs/CENG467_Term_Project}) \\
...
\texttt{src/hard\_negative\_mining.py} & Done \\
\texttt{data/hard\_negatives.json}     & Done \\
